  ...
  template: `
    <section class="rounded-2xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-sm">
      ...
      <ul class="mt-4 space-y-2 text-sm text-neutral-700">
        <li>
          <strong>Availability:</strong> Exports are securely available only when the report status reaches Approved or Closed.
        </li>
        <li>
          <strong>Connectivity:</strong> Online connectivity is strictly required to generate and download export documents from the server.
        </li>
        <li>
          <strong>Format:</strong> Export snapshots permanently embed all final inspection variables, timestamp history, and approval attribution fields for total operational traceability.
        </li>
      </ul>
    </section>
  `,
