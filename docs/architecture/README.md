...
This directory contains high-level architectural documentation for the Oilfield Tubular Services (OTS) project.

## Available Documents

-   [Template Versioning Architecture](./template-versioning.md) (T0.5.1)
