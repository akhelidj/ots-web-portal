...
_Note: The template binding fields (`templateKey`, `templateVersion`, `templateHash`, and `status`) are resolved exclusively on the server and ignored if passed by the client._
